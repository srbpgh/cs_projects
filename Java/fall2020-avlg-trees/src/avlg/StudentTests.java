...
public class StudentTests {
    ...
    @Test
    public void testBstTester() throws InvalidBalanceException {
    ...
    @Test
    public void advancedDeletion() throws EmptyTreeException, InvalidBalanceException {
    	tree = new AVLGTree<Integer>(5);
    ...
    @Test
    public void testSearch() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<Integer>(1);
    	tree.insert(5);
    	tree.insert(2);
    	tree.insert(10);
    	...
    	tree.insert(9);
    	tree.insert(15);
    	assertTrue(tree.search(15) == 15);
    	assertTrue(tree.search(10) == 10);
    	assertTrue(tree.search(5) == 5);
    	assertTrue(tree.search(2) == 2);
    	assertTrue(tree.search(1) == 1);
    	assertTrue(tree.search(9) == 9);
    	assertTrue(tree.search(4) == 4);
    	assertTrue(tree.search(43) == null);
    }
    
    @Test
    public void testExtreme() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<Integer>(1);
    	int num = 1000;
    	for (int i = 0; i < num; i ++) {
    	...
    	assertTrue(tree.search(943) == 943);
    	assertTrue(tree.search(-3) == null);
    	assertTrue(tree.search(12343) == null);
    ...
    @Test
    public void basicTests() throws InvalidBalanceException, EmptyTreeException{
    	tree = new AVLGTree<Integer>(1);
    	tree.insert(5);
    	tree.insert(3);
    	tree.insert(10);
    	tree.printTree();//test basic creation
    	
    	tree.insert(1);
    	tree.insert(2);
    	tree.printTree();//test right rotation
    	
    	tree.printNode(5);
    	tree.printNode(2);//test lr rotation
    	...
    	tree.insert(15);
    	tree.printTree();
    	tree.printNode(10);//test left rotation
    	
    	tree.insert(20);
    	tree.insert(17);
    	tree.printTree();
    	tree.printNode(10);
    	tree.printNode(17);//test rl rotation
